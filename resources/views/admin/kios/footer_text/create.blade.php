                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Tambah <span>Text Berjalan</span></h5>
                                <hr>

                                @include('admin.shared.error_validation')

                                <form class="row g-3" method="POST" action="{{ route('ConsoleStoreKiosFooterText') }}">
                                    @csrf
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" required aria-label="Default select example"
                                            ...
                                            @forelse ($displayNumbers as $displayNumber)
                                                <option value="{{ $displayNumber }}"><b>{{ $displayNumber }}</b></option>
                                            @empty
                                                <option value="0">
