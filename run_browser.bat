...
start msedge --app=http://localhost/antrian_bri_console/kios --kiosk --no-first-run --autoplay-policy=no-user-gesture-required --new-window --user-data-dir=%TEMP%/monitor1 --edge-kiosk-type=fullscreen
start msedge --app=http://localhost/antrian_bri_console/ --kiosk --no-first-run --autoplay-policy=no-user-gesture-required --new-window --user-data-dir=%TEMP%/monitor0 --edge-kiosk-type=fullscreen
